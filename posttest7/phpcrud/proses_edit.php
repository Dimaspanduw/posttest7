  ...
  if($gambar_produk != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'img/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE message SET nama = '$nama', email = '$email', notelp = '$notelp', alamat = '$alamat', gambar_produk = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE message SET nama = '$nama', email = '$email', notelp = '$notelp', alamat = '$alamat'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
